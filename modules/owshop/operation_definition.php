...
$OperationList['confirmbasket'] = array( 'name' => 'confirmbasket',
                                        'default_call_method' => array( 'include_file' => 'extension/owshop/modules/owshop/owshopoperationcollection.php',
                                                                        'class' => 'OWShopOperationCollection' ),
                                        'parameter_type' => 'standard',
                                        'parameters' => array( array( 'name' => 'item_count_list',
                                                        ...
                                                        array( 'name' => 'item_id_list',
                                                                'type' => 'array',
                                                                'required' => true ),
                                                        array( 'name' => 'product_collection_id',
                                                                'type' => 'integer',
                                                                'required' => true )
                                        ),
                                        'keys' => array( 'item_count_list', 'item_id_list', 'product_collection_id' ),
                                        'body' => array( array( 'type' => 'trigger',
                                                                'name' => 'pre_confirmbasket',
                                                                'keys' => array(  ) ),
                                                        array( 'type' => 'method',
                                                                'name' => 'confirm-basket',
                                                                'frequency' => 'once',
