...
<form action={concat("/owshop/customerlist")|ezurl} method="post" name="Customerlist">
...
{section var="Customer" loop=$customer_list sequence=array(bglight,bgdark)}
    ...
    <tr>
        <td class="{$Customer.sequence}"><a href={concat("/owshop/customerorderview/",$Customer.user_id,"/", $Customer.email)|ezurl}>{$Customer.account_name|wash}</a></td>
