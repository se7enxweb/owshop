...
<form name="productsoverview" action={'owshop/productsoverview'|ezurl} method="post">
...
{include name=navigator
         ...
         page_uri=concat( '/owshop/productsoverview/(product_class)/', $product_class.identifier)
