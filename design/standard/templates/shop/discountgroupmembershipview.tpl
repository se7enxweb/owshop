...
<div class="object">
    {$discountgroup.name|wash} <a href={concat("/owshop/discountgroupedit/",$discountgroup.id,"/")|ezurl}><img class="button" src={"edit.gif"|ezimage} width="16" height="16" alt="{'Edit'|i18n('design/standard/shop')}" /></a><br/>
</div>
